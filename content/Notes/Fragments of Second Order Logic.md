...
- [[Monadic Second Order Logic]]:
	- All second order quantifications have arity 1
- **Existential Monadic Second Order Logic:** ^4a6d80
	- All formulas are of the form:
	  $$\exists R_{1} \dots \exists R_{n}. \varphi$$
	  Further, $\varphi$ does not have any second order quantification and each $R_{i}$ has unary.
