...
# Ring
---
**Rings** are defined by adding additional data to an [[Abelian Groups|Abelian Group]] with the motivion of analysing structures similar to $\mathbb{Z}$ or $\mathbb{R}$ in further detail. To so, these are abelian groups are endowed with a 'multiplication operator'.
