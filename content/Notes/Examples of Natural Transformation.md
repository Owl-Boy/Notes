...
---
- [[Dual Vector Space Example]]. This examples involves the identity endofunctor in category $\text{Vect}_{R}$ and $ev$.
- On the contrary, the Identity endofunctor and the single dual functor are not naturally isomorphic. The construction of any isomorphism $V\cong V^*$ requires choosing of a bases which does not remain same under any transformation other than identity.
